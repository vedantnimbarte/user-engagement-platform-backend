const { decrypt, httpStatus, responseWithError } = require("@userplus/common");
const twilio = require("twilio");

async function getUserPhoneDetails(req, userId) {
  try {
    const query = `
            SELECT 
                u.first_name, 
...
async function sendOTPOnPhone(req, userId, replaceData, textContent) {
  try {

...
CREATE UNIQUE INDEX "ukey_condition_groups_condition_group" ON "condition_groups"("condition_group");
...
CREATE UNIQUE INDEX "ukey_device_type_name" ON "device_type"("name");
...
-- AddForeignKey
ALTER TABLE "up_attributes" ADD CONSTRAINT "fk_up_attributes_group_id_attribute_groups" FOREIGN KEY ("group_id") REFERENCES "attribute_groups"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
...
-- AddForeignKey
ALTER TABLE "user_session_activities" ADD CONSTRAINT "fk_user_session_activities_device_type_id_device_type" FOREIGN KEY ("device_type_id") REFERENCES "device_type"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
...
-- AddForeignKey
ALTER TABLE "user_session_activities_lives" ADD CONSTRAINT "fk_user_session_activities_lives_device_type_id_device_type" FOREIGN KEY ("device_type_id") REFERENCES "device_type"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;

INSERT INTO public.attribute_groups (id, name, key, status, created_at, created_by) VALUES (1, 'Browser Attributes', 'browser_attributes', 1, NOW(), NULL),(2, 'Nps', 'nps', 1, NOW(), NULL),(3, 'Checklist', 'checklist', 1, NOW(), NULL),(4, 'Product Tour', 'product_tour', 1, NOW(), NULL),(5, 'Custom', 'custom', 1, NOW(), NULL);
INSERT INTO public.condition_groups (id, name, description, status, created_at, created_by) VALUES (1, 'String Operators', 'String Operator condition Group', 1, NOW(), NULL),(2, 'Date Operators', 'Date Operators Group', 1, NOW(), NULL),(3, 'List Operators', 'List Operators Group', 1, NOW(), NULL),(4, 'Number Operators', 'Number Operators Group', 1, NOW(), NULL),(5, 'Boolean Operators', 'Boolean Operators Group', 1, NOW(), NULL),(8, 'Segment Operators', 'Segment Operators Group', 1, NOW(), NULL);
INSERT INTO public.conditions (id, condition_group_id, name, symbol, script, status, created_at, created_by) VALUES (1, 1, 'Equals', NULL, NULL, 1, NOW(), NULL),(2, 1, 'Doesn''t equal', NULL, NULL, 1, NOW(), NULL),(3, 1, 'Contains', NULL, NULL, 1, NOW(), NULL),(4, 1, 'Doesn''t contain', NULL, NULL, 1, NOW(), NULL),(5, 1, 'Starts with', NULL, NULL, 1, NOW(), NULL),(6, 1, 'Doesn''t start with', NULL, NULL, 1, NOW(), NULL),(7, 1, 'Ends with', NULL, NULL, 1, NOW(), NULL),(8, 1, 'Doesn''t end with', NULL, NULL, 1, NOW(), NULL),(13, 2, 'More than', NULL, NULL, 1, NOW(), NULL),(14, 2, 'Less than', NULL, NULL, 1, NOW(), NULL),(15, 2, 'After', NULL, NULL, 1, NOW(), NULL),(16, 2, 'Before', NULL, NULL, 1, NOW(), NULL),(17, 2, 'On', NULL, NULL, 1, NOW(), NULL),(18, 3, 'Is one of', NULL, NULL, 1, NOW(), NULL),(19, 3, 'Is not one of', NULL, NULL, 1, NOW(), NULL),(20, 4, 'Greater than or equal to', NULL, NULL, 1, NOW(), NULL),(21, 4, 'Less than or equal to', NULL, NULL, 1, NOW(), NULL),(22, 4, 'Equals', NULL, NULL, 1, NOW(), NULL),(23, 4, 'Doesn''t equal', NULL, NULL, 1, NOW(), NULL),(24, 5, 'Is true', NULL, NULL, 1, NOW(), NULL),(25, 5, 'Is false', NULL, NULL, 1, NOW(), NULL);
INSERT INTO public.data_types (id, name, key, description, status, created_at, created_by) VALUES (1, 'Text', 'string', 'String', 1, NOW(), NULL),(2, 'Number', 'number', 'Number', 1, NOW(), NULL),(3, 'True/False', 'boolean', 'Boolean', 1, NOW(), NULL),(4, 'DateTime', 'date', 'Date', 1, NOW(), NULL),(5, 'List', 'list', 'List', 1, NOW(), NULL);
INSERT INTO public.display_frequencies (id, type, status, created_at, created_by) VALUES (1, 'all the time', 1, NOW(), NULL),(2, 'show once', 1, NOW(), NULL);
INSERT INTO public.display_triggers (id, type, status, created_at, created_by) VALUES (1, 'Scroll percentage', 1, NOW(), NULL),(2, 'Exit intent', 1, NOW(), NULL),(3, 'Delay', 1, NOW(), NULL);
INSERT INTO public.events (id, name, type) VALUES ('17ddd4fe-ced2-4178-9ad9-adcfef45ed5a', 'page_view', 'system'),('9f549f32-0710-468c-b2f4-77441fb70ed0', 'ul_checklist_item_completed', 'system'),('0f7239dc-db9b-4d81-952a-cf2f51f5f64e', 'ul_checklist_dismissed', 'system'),('2a44fe50-dda8-4b36-a549-bd6436430f2c', 'ul_checklist_completed', 'system'),('5aeaa144-191d-442c-962f-6567e0ffc4a1', 'ul_checklist_triggered', 'system');
INSERT INTO public.fonts (id, name, status, created_at, created_by) VALUES (1, 'Courier New', 1, NOW(), NULL),(2, 'Courier', 1, NOW(), NULL),(3, 'monospace', 1, NOW(), NULL),(4, 'Franklin Gothic Medium', 1, NOW(), NULL),(5, 'Arial Narrow', 1, NOW(), NULL);
INSERT INTO public.positions (id, name, status, created_at, created_by) VALUES (1, 'Top Left', 1, NOW(), NULL),(2, 'Top Right', 1, NOW(), NULL),(3, 'Bottom Left', 1, NOW(), NULL),(4, 'Bottom Right', 1, NOW(), NULL);
INSERT INTO public.device_types (name) VALUES ('Desktop'),('Mobile'),('Tablet');
INSERT INTO public.browsers (name) VALUES ('MS Edge'),('Edge (chromium based)'),('Chrome'),('MS IE'),('Opera');
INSERT INTO public.operating_systems (name) VALUES ('Windows'),('Mac OS'),('Linux'),('Android'),('iOS');
INSERT INTO public.up_attributes (id, name, key, attribute_group_id, data_type_id, description, condition_group_id, is_system_attribute, status, created_at, created_by, reference_table) VALUES (1, 'Last seen at', 'last_seen_at', 1, 4, 'first seen at time', 2, true, 1, NOW(), NULL, NULL),(2, 'First seen at', 'first_seen_at', 1, 4, 'first seen at time', 2, true, 1, NOW(), NULL, NULL),(3, 'Country', 'country', 1, 1, 'Country Name', 3, true, 1, NOW(), NULL, NULL),(4, 'Region Name', 'region_name', 1, 1, 'Region Name', 1, true, 1, NOW(), NULL, NULL),(5, 'City', 'city', 1, 1, 'City Name', 1, true, 1, NOW(), NULL, NULL);
INSERT INTO public.theme_settings (theme, is_current, custom_css, survey, product_tour, checklist, demoz)
VALUES 
('dark',
    false,
    '{

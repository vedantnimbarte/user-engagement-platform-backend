...
import { startDashboard } from "./config/queueManager.js";
// Make logger globally available
global.$logger = logger;
const app = express();

import "./queueWorker/index.js";
import { shutdownQueueManager } from "./config/queueManager.js";
...
app.get("/health", (req, res) => {
  res
    .status(200)
    .json({ status: "OK", message: "BACKGROUND Server is running" });
});

// Routes
app.use("/ui", startDashboard().getRouter());
app.use("/", routes);
